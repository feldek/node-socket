...
type TRedisClient = RedisClientType<RedisDefaultModules & RedisModules, RedisFunctions, RedisScripts>;

const getClientName = (clientName: string | undefined): string => clientName ? `(${clientName})` : "";

/** todo replace {@link RedisClientWrapper} */
const createRedisClient = (config: TRedisConfig, options?: Partial<RedisClientOptions>): TRedisClient => {
